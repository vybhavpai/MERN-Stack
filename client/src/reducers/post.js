import { POST_ERROR, GET_POSTS, UPDATE_LIKES, DELETE_POST, ADD_POST, GET_POST, ADD_COMMENT, REMOVE_COMMENT } from "../actions/types"
...
export default function(state = initialState, action) {
    ...
    switch(type) {
        ...
        case ADD_COMMENT:
            return{...state, post: {...state, comments: payload}, loading: false}
